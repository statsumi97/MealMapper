...
Revision ID: 6bfe6514e73c
Revises: 
Create Date: 2024-02-29 11:39:03.126109
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['restaurant_id'], ['restaurants.id'], name=op.f('fk_user_favorites_restaurant_id_restaurants')),
